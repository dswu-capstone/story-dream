...
front / side / back / absent. When side/back or absent persists for 15s,
...
FOCUS_LOST_THRESHOLD = float(os.environ.get("FOCUS_LOST_THRESHOLD", "15"))
ABSENT_THRESHOLD = float(os.environ.get("ABSENT_THRESHOLD", "15"))
